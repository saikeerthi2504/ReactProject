...
function Drinks() {
  // Accessing drink products from the Redux store
  const drinkProducts = useSelector(globalState => globalState.product.Drinks);
  ...
  return (
    ...
    <div className="non-veg ">
      <h1 className="text-center">This is bigBasket:: drinks page</h1>
      <h1 className="text-center">🥤 Drink Items</h1>
